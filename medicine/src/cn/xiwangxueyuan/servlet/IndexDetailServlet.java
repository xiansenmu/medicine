 ...
 */
@WebServlet("/indexdetail.do")
public class IndexDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IndexDetailServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String preLink="indexdetail.do?page="+prePage;
		String nextLink="indexdetail.do?page="+nextPage;
